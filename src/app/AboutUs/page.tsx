  ...
  return (
    <div>
      <div className="bg-white">
        ...
        >
          <div className="flex md:flex-row flex-col gap-16 bg-white mx-auto pt-12 md:pb-24 max-w-5xl">
            ...
            <div className="col-span-1 md:col-span-8">
              <p className="mb-4 p-3 md:p-0 text-lg text-neutral-600 md:text-2xl">
              ...
              <p className="mb-8 p-3 md:p-0 text-lg text-neutral-600 md:text-2xl">
