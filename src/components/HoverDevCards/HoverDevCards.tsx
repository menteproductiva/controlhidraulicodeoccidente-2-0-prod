...
const HoverDevCards = ({
  ...
  return (
    <a className="relative border-[1px] border-slate-300 bg-white shadow-lg p-6 rounded-lg w-full transition-transform overflow-hidden group hover:scale-105">
      ...
      <p className="group-hover:text-black relative z-10 font-semibold text-black text-xs duration-300">
        {titleDescription}
      </p>
      ...
      <button
        ...
        className="relative z-10 flex flex-row justify-center items-center bg-green-500 hover:bg-green-600 mt-4 px-4 py-2 rounded-lg font-bold text-white transition-colors"
      >
